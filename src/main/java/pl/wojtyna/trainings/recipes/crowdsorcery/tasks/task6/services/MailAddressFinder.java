...
import pl.wojtyna.trainings.recipes.crowdsorcery.tasks.task6.domain.Borrower;
import pl.wojtyna.trainings.recipes.crowdsorcery.tasks.task6.domain.Investor;
