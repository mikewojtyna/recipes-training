package pl.wojtyna.trainings.recipes.crowdsorcery.solutions.tasks.task3.deposit.infra.event;

import org.springframework.context.event.EventListener;
import pl.wojtyna.trainings.recipes.crowdsorcery.solutions.tasks.task3.deposit.domain.account.DepositInitiated;
import pl.wojtyna.trainings.recipes.crowdsorcery.solutions.tasks.task3.deposit.domain.account.PaymentVerifiedPolicy;
import pl.wojtyna.trainings.recipes.crowdsorcery.solutions.tasks.task3.deposit.domain.payment.DepositInitiatedPolicy;
import pl.wojtyna.trainings.recipes.crowdsorcery.solutions.tasks.task3.deposit.domain.payment.PaymentVerified;
