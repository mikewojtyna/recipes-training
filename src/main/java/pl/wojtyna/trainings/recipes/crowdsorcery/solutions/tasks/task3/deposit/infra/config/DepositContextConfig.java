package pl.wojtyna.trainings.recipes.crowdsorcery.solutions.tasks.task3.deposit.infra.config;

import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import pl.wojtyna.trainings.recipes.common.domain.DomainEventPublisher;
import pl.wojtyna.trainings.recipes.crowdsorcery.solutions.tasks.task3.deposit.api.usecases.CreateAccountUseCase;
import pl.wojtyna.trainings.recipes.crowdsorcery.solutions.tasks.task3.deposit.api.usecases.WithdrawUseCase;
import pl.wojtyna.trainings.recipes.crowdsorcery.solutions.tasks.task3.deposit.domain.account.*;
import pl.wojtyna.trainings.recipes.crowdsorcery.solutions.tasks.task3.deposit.domain.payment.DepositInitiatedPolicy;
import pl.wojtyna.trainings.recipes.crowdsorcery.solutions.tasks.task3.deposit.domain.payment.PaymentProcessor;
import pl.wojtyna.trainings.recipes.crowdsorcery.solutions.tasks.task3.deposit.infra.event.LocalEventsHandler;
