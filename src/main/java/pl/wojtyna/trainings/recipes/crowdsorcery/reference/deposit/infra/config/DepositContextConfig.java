package pl.wojtyna.trainings.recipes.crowdsorcery.reference.deposit.infra.config;

import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import pl.wojtyna.trainings.recipes.crowdsorcery.reference.common.domain.DomainEventPublisher;
import pl.wojtyna.trainings.recipes.crowdsorcery.reference.deposit.api.usecases.CreateAccountUseCase;
import pl.wojtyna.trainings.recipes.crowdsorcery.reference.deposit.api.usecases.WithdrawUseCase;
import pl.wojtyna.trainings.recipes.crowdsorcery.reference.deposit.domain.account.*;
...
import pl.wojtyna.trainings.recipes.crowdsorcery.reference.deposit.infra.event.LocalEventsHandler;
